...
<div id="adminForm">
	<form name="addBlog" method="post" action="<?=QOOB_DOMAIN; ?>backdoor/addBlog/">
		<div class="row">
...
<?
	...
	switch ($postMenu) {
		...
		case 'date':
			...
			$msg = date('d/m/Y g:i a', $txtDateTime);
		break;
		default:
...
?>				
		...
		<div class="row">
			<div class="lbl"></div>
			<div class="inputs">
				<input type="submit" name="btnAdd" title=" Add Blog " value=" Add Blog Post " class="btnForm" onclick="return verify()"/>
			</div>
		</div>
